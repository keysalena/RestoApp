...
public class Theme {
    ...
    // Tambahkan ini di dalam class Theme.java
    public static JLabel iconLabel(String text, int size, Color color) {
        JLabel l = new JLabel(text);
        // Menggunakan "Segoe UI Symbol" karena paling lengkap untuk simbol ☰, 🛡, ⊞, dll.
    ...
    public static class StyledComboBox extends JComboBox<String> {
        public StyledComboBox(String[] items) {
            ...
            // Warna untuk kotak ComboBox utama saat tidak diklik
            setBackground(Color.BLACK); // Background Hitam
            setForeground(Color.BLACK); // Teks Putih
            setFont(FONT_BODY);
            setOpaque(true);
            ...
            // LOGIKA PENTING: Mengatur warna pada daftar pilihan (Dropdown List)
            setRenderer(new DefaultListCellRenderer() {
                ...
                public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                    ...
                    if (isSelected) {
                        // Warna saat pilihan disorot (Hover) dengan mouse
                        label.setBackground(Theme.ACCENT_ORANGE); 
                        label.setForeground(Color.WHITE);
                    } else {
                        // Warna dasar daftar pilihan
                        label.setBackground(Color.BLACK); 
                        label.setForeground(Color.WHITE); 
                    }
                    
                    // Memberikan jarak (padding) agar teks tidak terlalu mepet
