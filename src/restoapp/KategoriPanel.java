...
public class KategoriPanel extends JPanel implements DashboardFrame.Refreshable {
    ...
    private void buildUI() {
        ...
        JLabel title = Theme.label("Data Kategori", new Font("Segoe UI Emoji", Font.BOLD, 20), Theme.TEXT_WHITE);
        title.setBounds(20, 14, 300, 28); header.add(title);
        JLabel sub = Theme.label("Kelola kategori menu masakan", Theme.FONT_BODY, Theme.TEXT_MUTED);
    ...
    private JPanel buildTableSection() {
        ...
        JLabel t = Theme.label("■  Daftar Kategori", Theme.FONT_HEADING, Theme.TEXT_WHITE);
    ...
    private JPanel buildFormSection() {
        ...
        formTitle = Theme.label("■  Tambah Kategori Baru", Theme.FONT_HEADING, Theme.TEXT_WHITE);
        ...
        p.add(Theme.label("Nama Kategori *", Theme.FONT_LABEL, Theme.ACCENT_ORANGE)).setBounds(fx, fy, fw, 16);
    ...
    private void loadTable() {
        ...
        try {
            ...
            java.sql.ResultSet rs = st.executeQuery("SELECT * FROM kategori ORDER BY id_kategori DESC");
    ...
    private void onSelect() {
        ...
        if (row != -1) {
            ...
            formTitle.setText("■  Edit Kategori (ID: " + selectedId + ")");
    ...
    private void delete() {
       ...
       int c = JOptionPane.showConfirmDialog(this, "Yakin hapus kategori ini?", "Konfirmasi", JOptionPane.YES_NO_OPTION);
